            ...
            <div id="first">
                <div class="myform form ">
                    ...
                    <form action="login.php" method="post" name="login">
                        ...
                        <div class="col-md-12 text-center ">
                            <button type="submit" class=" btn btn-block mybtn btn-primary tx-tfm" name="login_user">
                                Login
                            </button>
                        </div>
                        <div class="col-md-12 ">
                ...
                <div class="myform form ">
                    ...
                    <form method="post" action="login.php" name="registration">
                        ...
                        <div class="col-md-12 text-center mb-3">
                            <button type="submit" class=" btn btn-block mybtn btn-primary tx-tfm" name="reg_user">Get
                                Started For Free
                            </button>
                        </div>
                        <div class="col-md-12 ">
